(function (window, angular, undefined) {
    ...
    angular.module('choco4me.services', []).value('version', '0.1');

    // phonegap ready service - listens to deviceready
    choco4me.factory('phonegapReady', function () {
        return function (fn) {
            var queue = [];
            var impl = function () {
    ...
    choco4me.factory('geolocation', function ($rootScope, phonegapReady) {
        return {
    ...
    choco4me.factory('accelerometer', function ($rootScope, phonegapReady) {
        return {
    ...
    choco4me.factory('notification', function ($rootScope, phonegapReady) {
        return {
    ...
    choco4me.factory('navSvc', function ($navigate) {
        return {
    ...
    choco4me.factory('compass', function ($rootScope, phonegapReady) {
        return {
    ...
    choco4me.factory('contacts', function ($rootScope, phonegapReady) {
        return {
